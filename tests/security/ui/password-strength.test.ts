...
describe('Password Strength Security Tests', () => {
  describe('Password Strength Calculation', () => {
    ...
    it('should require all character types for strong passwords', () => {
      const testCases = [
        { password: 'lowercase123!', expectedStrength: 'Strong' },
        { password: 'UPPERCASE123!', expectedStrength: 'Strong' },
        { password: 'MixedCase123', expectedStrength: 'Strong' },
        { password: 'MixedCase!@#', expectedStrength: 'Strong' },
      ];
    ...
    it('should provide specific feedback for password improvements', () => {
      const testCases = [
        { 
          password: 'short', 
          expectedFeedback: ['Use at least 8 characters', 'Add numbers', 'Add uppercase letters', 'Add special characters'] 
        },
        { 
  ...
  describe('Security Properties', () => {
    ...
    it('should enforce minimum requirements correctly', () => {
      const testCases = [
        ...
        { password: 'Abc123!', meetsMin: true },   // 7 chars but has upper, lower, number, special
        { password: 'abcd123!', meetsMin: true },  // 8 chars, lower, number, special (no upper but special compensates)
        { password: 'ABCD123!', meetsMin: true },  // 8 chars, upper, number, special (no lower but special compensates)
