...
- **Updates**: Check `npm outdated` weekly
- **Lockfile**: Always commit `package-lock.json`
- **Node Version**: Minimum 18.0.0

### Package Manager Rules

- **Primary**: NPM 10.0+ (project standard)
- **Installation**: Use `--ci` in CI environment
- **Cache**: Leverage NPM global cache
...
_Performance Rules Version: 1.0_  
