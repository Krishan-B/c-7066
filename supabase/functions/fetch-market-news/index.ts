...
// Deno global type declaration for type safety
declare const Deno: {
...
const generateMarketNews = (
  ...
  const allNews: MarketNewsItem[] = [
    // Crypto news
    {
      ...
      summary:
        "The leading cryptocurrency reaches new all-time high amid institutional adoption.",
    ...
    },
    {
      ...
      summary:
        "The upgrade aims to reduce gas fees and improve transaction throughput.",
    ...
    },
    {
      ...
      summary:
        "Users report transaction delays as network usage spikes to record levels.",
      source: "CoinDesk",
      url: "#",
    ...
    // Stock news
    {
      ...
      summary:
        "The tech giant unveiled new devices expected to boost holiday sales.",
      source: "MarketWatch",
      url: "#",
    ...
    },
    {
      ...
      summary:
        "Electric vehicle maker reports strong growth in deliveries and revenue.",
      source: "Bloomberg",
      url: "#",
    ...
    },
    {
      ...
      summary:
        "Social media giant under scrutiny from European regulators over data practices.",
      source: "Reuters",
      url: "#",
    ...
    // Index news
    {
      ...
      summary:
        "The benchmark index climbed on positive economic data and Fed comments.",
    ...
    },
    {
      ...
      summary:
        "Investors lock in gains after extended rally in technology stocks.",
      source: "CNBC",
      url: "#",
    ...
    },
    {
      ...
      summary:
        "Currency weakens as Bank of Japan maintains ultra-loose monetary policy.",
      source: "Reuters",
      url: "#",
    ...
    // Commodity news
    {
      ...
      summary:
        "Safe-haven demand drives precious metal higher as conflicts escalate.",
    ...
    },
    {
      ...
      summary:
        "Crude prices fall after weekly report shows unexpected supply increase.",
      source: "OilPrice",
      url: "#",
  ...
  return marketType
    ? allNews.filter((news) => news.market_type === marketType)
    : allNews;
};
...
serve(async (req: Request) => {
  ...
  try {
    ...
    const news: MarketNewsItem[] = generateMarketNews(market_type);
