...
CREATE OR REPLACE FUNCTION "public"."calculate_pnl"("p_user_id" "uuid", "p_symbol" "text" DEFAULT NULL::"text") RETURNS TABLE("symbol" "text", "unrealized_pnl" numeric, "realized_pnl" numeric, "total_pnl" numeric)
...
ALTER FUNCTION "public"."calculate_pnl"("p_user_id" "uuid", "p_symbol" "text") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."get_user_balance"("user_uuid" "uuid") RETURNS TABLE("currency" "text", "available_balance" numeric, "locked_balance" numeric, "total_balance" numeric)
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public', 'pg_temp'
    AS $$
BEGIN
...
ALTER FUNCTION "public"."get_user_balance"("user_uuid" "uuid") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."handle_parent_order_status_change"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
        BEGIN
...
ALTER FUNCTION "public"."handle_parent_order_status_change"() OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."orders" (
    ...
    "order_category" "text" DEFAULT 'primary'::"text",
    ...
    CONSTRAINT "orders_order_category_check" CHECK (("order_category" = ANY (ARRAY['primary'::"text", 'stop_loss'::"text", 'take_profit'::"text", 'trailing_stop'::"text"]))),
    CONSTRAINT "orders_order_type_check" CHECK (("order_type" = ANY (ARRAY['market'::"text", 'limit'::"text", 'stop'::"text", 'stop_limit'::"text", 'stop_loss'::"text", 'take_profit'::"text", 'trailing_stop'::"text"]))),
...
CREATE INDEX "idx_account_metrics_user_id" ON "public"."account_metrics" USING "btree" ("user_id");
...
CREATE INDEX "idx_assets_asset_class" ON "public"."assets" USING "btree" ("asset_class");
...
CREATE INDEX "idx_kyc_documents_category" ON "public"."kyc_documents" USING "btree" ("category");
...
CREATE OR REPLACE TRIGGER "trigger_parent_order_status_change" AFTER UPDATE ON "public"."orders" FOR EACH ROW EXECUTE FUNCTION "public"."handle_parent_order_status_change"();



CREATE OR REPLACE TRIGGER "update_account_metrics_last_updated" BEFORE UPDATE ON "public"."account_metrics" FOR EACH ROW EXECUTE FUNCTION "public"."update_updated_at_column"();
...
ALTER TABLE ONLY "public"."account_metrics"
    ADD CONSTRAINT "account_metrics_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id") ON DELETE CASCADE;
...
CREATE POLICY "Delete own assets" ON "public"."assets" FOR DELETE USING (("user_id" = "auth"."uid"()));



CREATE POLICY "Insert own assets" ON "public"."assets" FOR INSERT WITH CHECK (("user_id" = "auth"."uid"()));
...
CREATE POLICY "Select own assets" ON "public"."assets" FOR SELECT USING (("user_id" = "auth"."uid"()));



CREATE POLICY "Select own data" ON "public"."users" FOR SELECT USING (("id" = ( SELECT "auth"."uid"() AS "uid")));



CREATE POLICY "Update own assets" ON "public"."assets" FOR UPDATE USING (("user_id" = "auth"."uid"()));
...
CREATE POLICY "Users can delete their own KYC audit logs" ON "public"."kyc_audit_log" FOR DELETE TO "authenticated" USING ((( SELECT "auth"."uid"() AS "uid") = ("reviewed_by")::"uuid"));



CREATE POLICY "Users can delete their own KYC documents" ON "public"."kyc_documents" FOR DELETE USING (("auth"."uid"() = "user_id"));
...
CREATE POLICY "Users can insert orders for their accounts" ON "public"."orders" FOR INSERT WITH CHECK (("account_id" IN ( SELECT "accounts"."id"
   FROM "public"."accounts"
  WHERE ("accounts"."user_id" = "auth"."uid"()))));



CREATE POLICY "Users can insert positions for their accounts" ON "public"."positions" FOR INSERT WITH CHECK (("account_id" IN ( SELECT "accounts"."id"
   FROM "public"."accounts"
  WHERE ("accounts"."user_id" = "auth"."uid"()))));
...
CREATE POLICY "Users can update their own account metrics" ON "public"."account_metrics" FOR UPDATE USING (("auth"."uid"() = "user_id"));
...
CREATE POLICY "Users can update their own orders" ON "public"."orders" FOR UPDATE USING (("account_id" IN ( SELECT "accounts"."id"
   FROM "public"."accounts"
  WHERE ("accounts"."user_id" = "auth"."uid"()))));
...
CREATE POLICY "Users can update their own positions" ON "public"."positions" FOR UPDATE USING (("account_id" IN ( SELECT "accounts"."id"
   FROM "public"."accounts"
  WHERE ("accounts"."user_id" = "auth"."uid"()))));
...
CREATE POLICY "Users can view their own account metrics" ON "public"."account_metrics" FOR SELECT USING (("auth"."uid"() = "user_id"));
...
CREATE POLICY "Users can view their own orders" ON "public"."orders" FOR SELECT USING (("account_id" IN ( SELECT "accounts"."id"
   FROM "public"."accounts"
  WHERE ("accounts"."user_id" = "auth"."uid"()))));
...
CREATE POLICY "Users can view their own positions" ON "public"."positions" FOR SELECT USING (("account_id" IN ( SELECT "accounts"."id"
   FROM "public"."accounts"
  WHERE ("accounts"."user_id" = "auth"."uid"()))));
...
CREATE POLICY "select_own_account" ON "public"."accounts" FOR SELECT USING (("user_id" = "auth"."uid"()));
...
GRANT ALL ON FUNCTION "public"."calculate_pnl"("p_user_id" "uuid", "p_symbol" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."calculate_pnl"("p_user_id" "uuid", "p_symbol" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."calculate_pnl"("p_user_id" "uuid", "p_symbol" "text") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."get_user_balance"("user_uuid" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."get_user_balance"("user_uuid" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_user_balance"("user_uuid" "uuid") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."handle_parent_order_status_change"() TO "anon";
GRANT ALL ON FUNCTION "public"."handle_parent_order_status_change"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."handle_parent_order_status_change"() TO "service_role";
