...
import { AlertTriangle, TrendingUp, Settings, Target } from 'lucide-react';
...
const MarginOptimizer = () => {
    ...
    Object.keys(assetGroups).forEach((assetClass, index) => {
      ...
      if (Math.abs(avgLeverage - optimalLeverage) > 0.5) {
        ...
        newSuggestions.push({
          ...
          potentialSavings,
          riskReduction,
          confidence: Math.min(95, 70 + (Math.abs(avgLeverage - optimalLeverage) * 10)),
          reasoning: avgLeverage > optimalLeverage 
  ...
  const totalRiskReduction = suggestions.reduce((sum, s) => sum + s.riskReduction, 0);
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-3">
              <Label>Margin Efficiency Target: {settings.marginEfficiencyTarget}%</Label>
              <Slider
                value={[settings.marginEfficiencyTarget]}
                onValueChange={(value) => 
                  setSettings(prev => ({ ...prev, marginEfficiencyTarget: value[0] }))
                }
                max={100}
                min={50}
                step={5}
            ...
            <div className="space-y-2">
              <div className="flex items-center space-x-2">
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    setSettings(prev => ({ ...prev, diversificationEnabled: checked }))
                  }
                />
                <Label htmlFor="diversification">Enable Diversification Optimization</Label>
              </div>
              ...
              <div className="flex items-center space-x-2">
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    setSettings(prev => ({ ...prev, correlationAdjustment: checked }))
                  }
                />
                <Label htmlFor="correlation">Apply Correlation Adjustments</Label>
              </div>
            </div>
          </div>
        </CardContent>
          ...
          <Card>
            <CardContent className="pt-6">
              <div className="text-center text-muted-foreground">
                ...
                <br />
                <span className="text-sm">Try adjusting your risk tolerance or efficiency targets.</span>
              </div>
            </CardContent>
          </Card>
        ) : (
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div className="text-center">
                      <div className="text-sm text-muted-foreground">Current Leverage</div>
                    ...
                    <div className="text-center">
                      <div className="text-sm text-muted-foreground">Suggested Leverage</div>
                  ...
                  <div className="flex justify-end">
                    ...
                    >
                      {loading ? 'Applying...' : isApplied ? 'Applied' : 'Apply Optimization'}
                    </Button>
                  </div>
                </CardContent>
              </Card>
