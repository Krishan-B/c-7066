  ...
  return (
    <div ref={chartSectionRef}>
      <div className="flex items-center gap-4 mb-4">
        ...
        <div
          className={`px-3 py-1 text-sm rounded-full ${marketIsOpen ? 'bg-success/20 text-success' : 'bg-warning/20 text-warning'}`}
        >
          ...
          <div className="p-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div
                  className={`mt-2 px-3 py-2 text-xs rounded-md ${marketIsOpen ? 'bg-success/10 text-success' : 'bg-warning/10 text-warning'}`}
                >
