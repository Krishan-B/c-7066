import { AlertTriangle, ChartLine, Globe } from 'lucide-react';
      ...
      <CardContent>
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            ...
            <div
              className={`rounded-full px-2 py-1 text-xs ${marketIsOpen ? 'bg-success/20 text-success' : 'bg-warning/20 text-warning'}`}
            >
